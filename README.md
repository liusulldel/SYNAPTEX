...
[![Memory: Infinite](https://img.shields.io/badge/Memory-∞-ff6b6b.svg)]()
[![Compression: 87%](https://img.shields.io/badge/Token_Saved-87%25-00d2d3.svg)]()
[![SOTA: 2026](https://img.shields.io/badge/SOTA-2026-8854d0.svg)]()
...
```mermaid
graph TD
    INPUT["🎤 User / Agent Input"] --> ROUTER{"⚡ SYNAPTEX Core Router"}
    
    ROUTER -->|Emotion Analysis| DOPA["🧪 Dopamine Weight Assigner<br/>ε ∈ [0,1]"]
    ROUTER -->|Query Routing| SWIFT["🔍 SwiftMem Index<br/>O(log N) Retrieval"]
    
    DOPA --> ENCODER{"🌐 Polyglot Compression Engine"}
    
    ENCODER -->|"文言文 / Optimal"| L1["📜 L1: 史记摘要<br/>~11 tokens per event"]
    ENCODER -->|"半文言+MD"| L2["📋 L2: 编年史骨架<br/>Timeline + Logic"]
    ENCODER -->|"Raw append"| L3["🗄️ L3: 潜意识细节池<br/>Verbatim Cold Storage"]
    
    SWIFT --> L1
    SWIFT -.->|"Need reasoning"| L2
    SWIFT -.->|"Need truth"| L3
    
    L1 --> FOX["🦊 Forgetting Gate<br/>Data-Dependent Decay"]
    L2 --> FOX
    FOX --> AMEM["🕸️ A-MEM Graph<br/>Zettelkasten Evolution"]
    
    AMEM --> PAGER["📟 MemGPT Pager<br/>Virtual Context Management"]
    PAGER --> CTX["🧠 Context Window<br/>Optimized Output"]
    
    style L1 fill:#ff6b6b,color:#fff
    style L2 fill:#ffa502,color:#fff
    style L3 fill:#747d8c,color:#fff
    style CTX fill:#2ed573,color:#fff
```
